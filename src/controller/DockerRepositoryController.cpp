...
#include "DockerRepositoryController.hpp"

std::shared_ptr<DockerRepositoryController::OutgoingResponse> DockerRepositoryController::getStaticFileResponse(const oatpp::String& filename,
...
std::shared_ptr<DockerRepositoryController::OutgoingResponse> DockerRepositoryController::getFullFileResponse(const oatpp::String& file) const {
    return createResponse(Status::CODE_200, file);
}

std::shared_ptr<DockerRepositoryController::OutgoingResponse> DockerRepositoryController::getRangeResponse(const oatpp::String& rangeStr,
