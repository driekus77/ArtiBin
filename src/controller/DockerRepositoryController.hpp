...
#ifndef ARTIBIN_DOCKERREPOSITORYCONTROLLER_HPP
#define ARTIBIN_DOCKERREPOSITORYCONTROLLER_HPP
 ...
 */
class DockerRepositoryController : public oatpp::web::server::api::ApiController {
public:
    typedef DockerRepositoryController __ControllerType;
private:
...
public:
    DockerRepositoryController(const std::shared_ptr<ObjectMapper>& objectMapper)
...
public:
     ...
     */
    static std::shared_ptr<DockerRepositoryController> createShared(OATPP_COMPONENT(std::shared_ptr<ObjectMapper>, objectMapper)){
        return std::shared_ptr<DockerRepositoryController>(std::make_shared<DockerRepositoryController>(objectMapper));
    }
...
#include OATPP_CODEGEN_BEGIN(ApiController)
    ...
    ENDPOINT_ASYNC_INIT(Live)
        ...
        Action act() override {
            ...
            auto response = controller->createResponse(Status::CODE_200, "Test!");
     ...
     */
    ENDPOINT_ASYNC("GET", "repositories/docker/*", Static) {
...
#endif //ARTIBIN_DOCKERREPOSITORYCONTROLLER_HPP
